...
const PopupCard = ({ close, startDate, rules, link, endDate, btn, changed, setChanged, Name, desc, img, id }) => {
  ...
  return (
    <div>
      <div className="bg-[rgba(0,0,0,.7)]  border-black">
        <div className="fixed top-0 right-0 left-0 bottom-0 z-1000 mx-auto rounded-[15px] w-[370px] sm: w-[90%] lg:w-[80%] xl:w-[60%] h-[600px] bg-white mt-5 ml-5 sm:mt-0 sm:ml-5 lg:ml-[300px] border border-blue-600">
          <div className="mt-[30px] mr-3">
            <button
          ...
          <button
            className="float-right mt-5 mr-5 sm:mr-10 bg-blue-500 text-white rounded-full py-2 px-4 hover:bg-blue-600"
            onClick={() => {
              if (btn == "Register Now") {
